          ...
          <div class="fb-rules">
            ...
            <section>
              ...
              <div class="rule-main">
                <p>
                  {tr(
                    'By participating in the contest, you agree to release Cybsec, and the Innovation Garage from any and all liability, claims or actions of any kind whatsoever for injuries, damages or losses to persons and property which may be sustained in connection with the contest. You acknowledge and agree that Cybsec et al is not responsible for technical, hardware or software failures, or other errors or problems which may occur in connection with the contest.',
                  )}
                </p>
              </div> 
            </section>
